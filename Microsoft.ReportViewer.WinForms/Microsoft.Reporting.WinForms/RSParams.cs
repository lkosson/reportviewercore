...
namespace Microsoft.Reporting.WinForms
{
	internal class RSParams : MirrorPanel
	{
		...
		private void InitializeComponent()
		{
			...
			buttonPanel.Location = new Point(422, 0);
			buttonPanel.Size = new Size(112, 71);
			buttonPanel.TabIndex = 2;
			splitterViewer.Enabled = false;
			splitterViewer.Size = new Size(1, 71);
			splitterViewer.TabIndex = 1;
			...
			viewReport.Location = new Point(5, 8);
			viewReport.Size = new Size(80, 23);
			viewReport.Text = "View Report";
			viewReport.Name = "viewReport";
			toolTipForParams.SetToolTip(viewReport, "View Report");
			...
			linkChangeCredentials.Text = "Change Credentials";
			linkChangeCredentials.Dock = DockStyle.Top;
			linkChangeCredentials.Padding = new Padding(3, 0, 0, 0);
			linkChangeCredentials.Size = new Size(422, 24);
			linkChangeCredentials.TextAlign = ContentAlignment.MiddleLeft;
			promptPanel.AutoScroll = true;
			promptPanel.Dock = DockStyle.Fill;
			promptPanel.Location = new Point(0, 24);
			promptPanel.Padding = new Padding(5, 0, 0, 0);
			promptPanel.Size = new Size(422, 47);
