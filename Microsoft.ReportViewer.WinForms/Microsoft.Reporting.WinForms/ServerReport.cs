...
namespace Microsoft.Reporting.WinForms
{
    ...
    {
        private Uri m_serverUrl = new("http://localhost/reportserver");

        private IReportServerCredentials m_serverCredentials;

        private readonly ReportServerCredentials m_serverCredentialsImpl;

        private System.Security.Principal.WindowsIdentity m_serverIdentity;

        private readonly ReportViewerHeaderCollection m_headers;

        private readonly ReportViewerCookieCollection m_cookies;
        ...
        private readonly List<int> m_hiddenParameters = new();
        ...
        private readonly AbortState m_abortState = new();
        ...
        {
            ExecutionIDChanged?.Invoke(this, EventArgs.Empty);
        }
        ...
        internal override int PerformSort(string sortId, SortOrder sortDirection, bool clearSort, PageCountMode pageCountMode, out string uniqueName)
        {
            lock (m_syncObject)
            {
                ...
                int result = Service.Sort(sortId, sortDirection, clearSort, pageCountMode, out uniqueName, out ExecutionInfo executionInfo, out int numPages);
                Service.SetExecutionId(m_executionID);
