...
namespace Microsoft.ReportingServices.Rendering.HtmlRenderer
{
	...
	public abstract class RenderingExtensionBase : IRenderingExtension, IExtension, ITotalPages
	{
		...
		{
			ProcessingContext.LoadImageResource(resourceName, resourceManager, createAndRegisterStreamCallback);
		}
