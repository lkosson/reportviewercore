namespace Microsoft.ReportingServices.Rendering.RPLProcessing
{
	internal class RPLFormat
	{
		...
		public class ItemProps
		{
			...
			public const byte PrintBetweenSections = 47;

			public const byte PageName = 48;

			public const byte ImageConsolidationOffsets = 49;
		...
		public const byte SectionStart = 21;

		public const byte SectionPropertiesStart = 22;
		...
		public const byte Map = 21;

		public const byte ElementEnd = 254;

		public const byte Delimiter = byte.MaxValue;

		public const byte ImageConsolidationOffsets2008 = 47;
	}
}
