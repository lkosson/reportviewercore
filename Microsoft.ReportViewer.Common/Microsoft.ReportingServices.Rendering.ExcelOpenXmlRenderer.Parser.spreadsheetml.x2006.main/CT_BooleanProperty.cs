...
{
	internal class CT_BooleanProperty : OoxmlComplexType
	{
		private OoxmlBool _val_attr;

		public OoxmlBool Val_Attr
		{
			get
			{
				return _val_attr;
		...
		{
			if ((bool)(_val_attr != OoxmlBool.OoxmlTrue))
			{
				s.Write(" val=\"");
