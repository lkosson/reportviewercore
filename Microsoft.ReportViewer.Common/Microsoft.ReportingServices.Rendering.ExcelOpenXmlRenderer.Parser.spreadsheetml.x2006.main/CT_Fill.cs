...
namespace Microsoft.ReportingServices.Rendering.ExcelOpenXmlRenderer.Parser.spreadsheetml.x2006.main
{
	internal class CT_Fill : OoxmlComplexType
	{
		...
		public static string PatternFillElementName => "patternFill";
		...
		{
			Write_patternFill(s, depth, namespaces);
		}

		public void Write_patternFill(TextWriter s, int depth, Dictionary<string, string> namespaces)
		{
			if (_choice_0 == ChoiceBucket_0.patternFill && _patternFill != null)
			{
				_patternFill.Write(s, "patternFill", depth + 1, namespaces);
			}
		}
	}
}
