...
{
	internal class CT_UnderlineProperty : OoxmlComplexType
	{
		private ST_UnderlineValues _val_attr;

		public ST_UnderlineValues Val_Attr
		{
			get
			{
				return _val_attr;
		...
		{
			_val_attr = ST_UnderlineValues.single;
		}
		...
		{
			if (_val_attr != ST_UnderlineValues.single)
			{
				s.Write(" val=\"");
