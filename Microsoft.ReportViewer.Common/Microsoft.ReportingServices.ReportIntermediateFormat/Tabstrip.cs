...
namespace Microsoft.ReportingServices.ReportIntermediateFormat
{
	...
	internal sealed class Tabstrip : Navigation
	{
		...
		internal override void Initialize(Tablix tablix, InitializationContext context)
		{
			...
			{
				m_navigationItem.Initialize(tablix, context, "Tabstrip");
			}
		}
		...
		internal new static Declaration GetDeclaration()
		{
			...
			return new Declaration(Microsoft.ReportingServices.ReportIntermediateFormat.Persistence.ObjectType.Tabstrip, Microsoft.ReportingServices.ReportIntermediateFormat.Persistence.ObjectType.Navigation, list);
		}
