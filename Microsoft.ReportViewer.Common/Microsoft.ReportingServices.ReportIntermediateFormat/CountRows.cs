...
namespace Microsoft.ReportingServices.ReportIntermediateFormat
{
	internal sealed class CountRows : DataAggregate
	{
		...
		internal override DataAggregateInfo.AggregateTypes AggregateType => DataAggregateInfo.AggregateTypes.CountRows;
		...
		{
			Global.Tracer.Assert(condition: false, "CountRows should not resolve references");
		}
		...
		public static Declaration GetDeclaration()
		{
			if (m_declaration == null)
			{
				...
				return new Declaration(Microsoft.ReportingServices.ReportIntermediateFormat.Persistence.ObjectType.CountRows, Microsoft.ReportingServices.ReportIntermediateFormat.Persistence.ObjectType.None, list);
			}
